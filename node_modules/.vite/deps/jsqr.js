...
var require_jsQR = /* @__PURE__ */ __commonJS({ "node_modules/jsqr/dist/jsQR.js": ((exports, module) => {
	(function webpackUniversalModuleDefinition(root, factory) {
		...
		return (function(modules) {
			...
			(function(module$1, exports$1, __webpack_require__) {
				...
				var Matrix = function() {
					function Matrix$1(width, height) {
						this.width = width;
						this.data = new Uint8ClampedArray(width * height);
					}
					Matrix$1.prototype.get = function(x, y) {
						return this.data[y * this.width + x];
					};
					Matrix$1.prototype.set = function(x, y, value) {
			...
			(function(module$1, exports$1, __webpack_require__) {
				...
				function getDataBlocks(codewords, version, ecLevel) {
					...
					ecInfo.ecBlocks.forEach(function(block) {
						for (var i$1 = 0; i$1 < block.numBlocks; i$1++) {
							dataBlocks.push({
			...
			(function(module$1, exports$1, __webpack_require__) {
				...
				var Mode;
				(function(Mode$1) {
					Mode$1["Numeric"] = "numeric";
					Mode$1["Alphanumeric"] = "alphanumeric";
					Mode$1["Byte"] = "byte";
					Mode$1["Kanji"] = "kanji";
					Mode$1["ECI"] = "eci";
				...
				var ModeByte;
				(function(ModeByte$1) {
					ModeByte$1[ModeByte$1["Terminator"] = 0] = "Terminator";
					ModeByte$1[ModeByte$1["Numeric"] = 1] = "Numeric";
					ModeByte$1[ModeByte$1["Alphanumeric"] = 2] = "Alphanumeric";
					ModeByte$1[ModeByte$1["Byte"] = 4] = "Byte";
					ModeByte$1[ModeByte$1["Kanji"] = 8] = "Kanji";
					ModeByte$1[ModeByte$1["ECI"] = 7] = "ECI";
				})(ModeByte || (ModeByte = {}));
				...
				function decodeByte(stream, size) {
					...
					try {
						text += decodeURIComponent(bytes.map(function(b$1) {
			...
			(function(module$1, exports$1, __webpack_require__) {
				...
				function extract(image, location) {
					...
					var mappingFunction = function(x$1, y$1) {
						var denominator = transform.a13 * x$1 + transform.a23 * y$1 + transform.a33;
						return {
							x: (transform.a11 * x$1 + transform.a21 * y$1 + transform.a31) / denominator,
							y: (transform.a12 * x$1 + transform.a22 * y$1 + transform.a32) / denominator
						};
					};
			...
			(function(module$1, exports$1, __webpack_require__) {
				...
				function locate(matrix) {
					...
					var _loop_1 = function(y$1) {
						...
						var _loop_2 = function(x$1) {
							var v = matrix.get(x$1, y$1);
							if (v === lastBit) length_1++;
								...
								if (validFinderPattern) {
									var endX_1 = x$1 - scans[3] - scans[4];
					...
					var finderPatternGroups = finderPatternQuads.filter(function(q) {
						...
						var y$1 = (q.top.y + q.bottom.y + 1) / 2;
						if (!matrix.get(Math.round(x), Math.round(y$1))) return;
						var lengths = [
